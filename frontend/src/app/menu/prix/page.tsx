...
export const metadata: Metadata = {
  title: 'Menu & Carte avec Prix — Le Sciøt Cial Club',
  description:
    'Notre carte avec les prix : cuisine simple et gourmande à base de produits locaux et de saison. Formules, plats, vins et boissons au Sciøt Cial Club à Les Pieux, Cotentin.',
  alternates: {
    canonical: 'https://www.lesciotcialclub.fr/menu/prix',
  },
  openGraph: {
    title: 'Menu & Carte avec Prix | Le Sciøt Cial Club',
    description:
      'Cuisine simple et gourmande à base de produits locaux de Normandie. Formules, plats du jour, vins et boissons.',
    url: 'https://www.lesciotcialclub.fr/menu/prix',
    type: 'website',
  },
};
...
export default async function MenuPrixPage() {
  ...
  return (
    <>
      ...
      {/* ── Interactive menu ── */}
      <MenuClient menu={menu} showPrices={true} />
    </>
  );
}
